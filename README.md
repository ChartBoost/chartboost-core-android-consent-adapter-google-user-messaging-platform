...
The Chartboost Core Google UMP adapter mediates Google User Messaging Platform SDK via the Chartboost Core SDK.
...
```
    implementation "com.chartboost:chartboost-core-adapter-google-ump:1.2.2.0.0"
```
